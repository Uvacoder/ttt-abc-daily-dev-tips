...
Creating pages is an integral part of any framework. Today we'll be looking at three different types of pages we can leverage in Next.js.
...
So let's break it up into sections and fill those out.
...
We create a simple render of each show's card, with an image and title of the anime show.
